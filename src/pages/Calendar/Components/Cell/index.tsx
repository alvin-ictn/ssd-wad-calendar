...
export default ({ day, disabled }: any) => {
    ...
    return <div onClick={createEvent} className={`${disabled ? "bg-slate-500" : "cursor-pointer hover:bg-sky-300"} flex flex-col items-center w-[calc(100%/7)] h-60 border border-slate-300 p-2`}>
